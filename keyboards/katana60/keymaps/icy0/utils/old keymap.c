...
[BASE] = LAYOUT( /* Base */
  KC_ESC,  KC_BSLS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,     TG(1),     KC_6,  KC_7,   KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQUAL,
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC,          KC_RBRC, KC_Z,    KC_U,    KC_I,    KC_O,       KC_P, KC_SLSH,
  MO(3),   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME,          KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    KC_QUOT, KC_RALT,
...
[NUMB] = LAYOUT(
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, KC_PSLS, KC_PAST,    KC_PMNS, XXXXXXX, XXXXXXX,
...
[SYMB] = LAYOUT(
    RESET, XXXXXXX,   KC_F1,   KC_F2,   KC_F3,     KC_F4,   KC_F5, XXXXXXX,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,
